...
This directory contains the durable public documentation for Shinjuku Indoor Navigator. Historical phase reports and completed implementation plans are intentionally omitted; the local pre-sanitization backup preserves that development history.
...
| [Design and implementation review](PROJECT_DESIGN_AND_IMPLEMENTATION_REVIEW.md) | A step-by-step explanation of how to design and build the project from the beginning |
