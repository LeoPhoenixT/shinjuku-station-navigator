...
CI enforces these in application, browser, and container jobs. Dependency updates are reviewed and applied intentionally rather than opened automatically.
